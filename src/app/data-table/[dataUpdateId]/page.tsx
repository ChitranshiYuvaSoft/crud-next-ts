...
const page = () => {
  return (
    <div className="w-full h-[100vh] bg-blue-300 flex items-center justify-center flex-col">
      ...
      <h1 className="text-slate-700 font-bold text-3xl text-start w-full px-5">Update Data</h1>
      <h6 className="text-base font-semibold text-slate-500 text-start w-full px-5">Fill All Details & Update Data....</h6>
      </div>
     </div>
